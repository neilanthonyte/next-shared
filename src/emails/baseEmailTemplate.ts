...
<h1 class="null" style="display: block;margin: 0;padding: 0;color: #006e63;font-family: Helvetica;font-size: 26px;font-style: normal;font-weight: bold;line-height: 125%;letter-spacing: normal;text-align: left;">${header}</h1>
<br>
${body}
                        </td>
                    </tr>
